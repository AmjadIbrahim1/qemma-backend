...
class AuthController {
  ...
  /**
   * POST /api/auth/clerk
   * Body: { clerkUserId, role, division, subject, teacherName }
   */
  async loginClerk(req, res, next) {
    try {
      console.log('📨 Clerk login request:', req.body);

      const { clerkUserId, role, division, subject, teacherName } = req.body;
      ...
      // ✅ Pass all fields to service — username is generated on the backend
