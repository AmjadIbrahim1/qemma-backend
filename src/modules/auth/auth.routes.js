...
router.post(
  "/assistant/verify-code",
  assistantVerificationController.verifyCode,
);
router.get(
  "/assistant/teacher/:username",
  assistantVerificationController.getTeacher,
);

// ── Parent / student verification ───────────────────────────
router.post(
  "/parent/send-code",
  assistantVerificationController.sendParentCode,
);
router.post(
  "/parent/verify-code",
  assistantVerificationController.verifyParentCode,
);
router.get(
  "/parent/student/:username",
  assistantVerificationController.getStudent,
);
...
router.get(
  "/debug/credentials",
  authMiddleware,
  authController.debugCredentials,
);
