...
class ExamsService {
  ...
  async createExam(userId, data) {
    ...
    const {
      ...
      proctored, isPublished, questions = [],
    } = data;
    ...
    if (published) await this._emitToEnrolledStudents(courseId, 'exam:published', formatted);
    return formatted;
  }
  ...
  async updateExam(examId, userId, data) {
    ...
    const {
      ...
      passingMarks, availableFrom, availableTo, proctored, isPublished,
    } = data;
